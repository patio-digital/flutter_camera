...
public class CameraPlugin implements MethodCallHandler {
      ...
      case "takePicture":
        {
          ...
          final Boolean exibirFlash = call.argument("flash");
          camera.takePicture(filePath, exibirFlash, result);
          break;
        }
  ...
  private class Camera {
    ...
    private void takePicture(String filePath, Boolean exibirFlash, @NonNull final Result result) {
